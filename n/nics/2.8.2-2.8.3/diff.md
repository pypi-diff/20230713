# Comparing `tmp/nics-2.8.2.tar.gz` & `tmp/nics-2.8.3.tar.gz`
...
### Comparing `nics-2.8.2/nics/main/_template/web/_sass/header.scss` & `nics-2.8.3/nics/main/_template/web/_sass/header.scss`
