# Comparing `tmp/evaluateqa-0.1.1.tar.gz` & `tmp/evaluateqa-0.1.2.tar.gz`
...
+gzip compressed data, was "evaluateqa-0.1.2.tar", max compression
```

## Comparing `evaluateqa-0.1.1.tar` & `evaluateqa-0.1.2.tar`
...
+-rw-r--r--   0        0        0     1073 2023-07-13 14:56:58.033887 evaluateqa-0.1.2/LICENSE
+-rw-r--r--   0        0        0      623 2023-07-13 14:56:58.033887 evaluateqa-0.1.2/README.md
+-rw-r--r--   0        0        0        0 2023-07-13 14:56:58.033887 evaluateqa-0.1.2/evaluateqa/__init__.py
+-rw-r--r--   0        0        0       65 2023-07-13 14:56:58.033887 evaluateqa-0.1.2/evaluateqa/mintaka/__init__.py
+-rw-r--r--   0        0        0    12519 2023-07-13 15:35:01.987830 evaluateqa-0.1.2/evaluateqa/mintaka/evaluate.py
+-rw-r--r--   0        0        0      497 2023-07-13 15:35:14.671731 evaluateqa-0.1.2/pyproject.toml
+-rw-r--r--   0        0        0     1476 1970-01-01 00:00:00.000000 evaluateqa-0.1.2/PKG-INFO
```

### Comparing `evaluateqa-0.1.1/LICENSE` & `evaluateqa-0.1.2/LICENSE`

 * *Files identical despite different names*

### Comparing `evaluateqa-0.1.1/README.md` & `evaluateqa-0.1.2/README.md`

 * *Files identical despite different names*

### Comparing `evaluateqa-0.1.1/evaluateqa/mintaka/evaluate.py` & `evaluateqa-0.1.2/evaluateqa/mintaka/evaluate.py`
...
### Comparing `evaluateqa-0.1.1/PKG-INFO` & `evaluateqa-0.1.2/PKG-INFO`
