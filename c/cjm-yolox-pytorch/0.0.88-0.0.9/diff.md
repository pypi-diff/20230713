# Comparing `tmp/cjm-yolox-pytorch-0.0.88.tar.gz` & `tmp/cjm-yolox-pytorch-0.0.9.tar.gz`

## filetype from file(1)

```diff
@@ -1 +1 @@
-gzip compressed data, was "cjm-yolox-pytorch-0.0.88.tar", last modified: Thu Jul 13 07:54:32 2023, max compression
+gzip compressed data, was "cjm-yolox-pytorch-0.0.9.tar", last modified: Mon Jul  3 19:21:36 2023, max compression
```

## Comparing `cjm-yolox-pytorch-0.0.88.tar` & `cjm-yolox-pytorch-0.0.9.tar`

### file list

```diff
@@ -1,23 +1,23 @@
-drwxrwxrwx   0 innom-dt  (1000) innom-dt  (1000)        0 2023-07-13 07:54:32.000302 cjm-yolox-pytorch-0.0.88/
--rwxrwxrwx   0 innom-dt  (1000) innom-dt  (1000)     1075 2023-06-22 23:01:16.000000 cjm-yolox-pytorch-0.0.88/LICENSE
--rwxrwxrwx   0 innom-dt  (1000) innom-dt  (1000)      111 2023-04-27 10:12:58.000000 cjm-yolox-pytorch-0.0.88/MANIFEST.in
--rwxrwxrwx   0 innom-dt  (1000) innom-dt  (1000)     1816 2023-07-13 07:54:32.000138 cjm-yolox-pytorch-0.0.88/PKG-INFO
--rwxrwxrwx   0 innom-dt  (1000) innom-dt  (1000)     1050 2023-07-04 21:34:25.000000 cjm-yolox-pytorch-0.0.88/README.md
-drwxrwxrwx   0 innom-dt  (1000) innom-dt  (1000)        0 2023-07-13 07:54:31.997555 cjm-yolox-pytorch-0.0.88/cjm_yolox_pytorch/
--rwxrwxrwx   0 innom-dt  (1000) innom-dt  (1000)       23 2023-07-13 07:53:48.000000 cjm-yolox-pytorch-0.0.88/cjm_yolox_pytorch/__init__.py
--rwxrwxrwx   0 innom-dt  (1000) innom-dt  (1000)    11997 2023-07-13 07:53:48.000000 cjm-yolox-pytorch-0.0.88/cjm_yolox_pytorch/_modidx.py
--rwxrwxrwx   0 innom-dt  (1000) innom-dt  (1000)    15400 2023-07-13 07:53:48.000000 cjm-yolox-pytorch-0.0.88/cjm_yolox_pytorch/loss.py
--rwxrwxrwx   0 innom-dt  (1000) innom-dt  (1000)    35626 2023-07-13 07:53:48.000000 cjm-yolox-pytorch-0.0.88/cjm_yolox_pytorch/model.py
--rwxrwxrwx   0 innom-dt  (1000) innom-dt  (1000)    14772 2023-07-13 07:53:48.000000 cjm-yolox-pytorch-0.0.88/cjm_yolox_pytorch/simota.py
--rwxrwxrwx   0 innom-dt  (1000) innom-dt  (1000)     2614 2023-07-13 07:53:48.000000 cjm-yolox-pytorch-0.0.88/cjm_yolox_pytorch/utils.py
-drwxrwxrwx   0 innom-dt  (1000) innom-dt  (1000)        0 2023-07-13 07:54:31.999805 cjm-yolox-pytorch-0.0.88/cjm_yolox_pytorch.egg-info/
--rwxrwxrwx   0 innom-dt  (1000) innom-dt  (1000)     1816 2023-07-13 07:54:31.000000 cjm-yolox-pytorch-0.0.88/cjm_yolox_pytorch.egg-info/PKG-INFO
--rwxrwxrwx   0 innom-dt  (1000) innom-dt  (1000)      506 2023-07-13 07:54:31.000000 cjm-yolox-pytorch-0.0.88/cjm_yolox_pytorch.egg-info/SOURCES.txt
--rwxrwxrwx   0 innom-dt  (1000) innom-dt  (1000)        1 2023-07-13 07:54:31.000000 cjm-yolox-pytorch-0.0.88/cjm_yolox_pytorch.egg-info/dependency_links.txt
--rwxrwxrwx   0 innom-dt  (1000) innom-dt  (1000)       56 2023-07-13 07:54:31.000000 cjm-yolox-pytorch-0.0.88/cjm_yolox_pytorch.egg-info/entry_points.txt
--rwxrwxrwx   0 innom-dt  (1000) innom-dt  (1000)        1 2023-06-23 01:14:13.000000 cjm-yolox-pytorch-0.0.88/cjm_yolox_pytorch.egg-info/not-zip-safe
--rwxrwxrwx   0 innom-dt  (1000) innom-dt  (1000)       45 2023-07-13 07:54:31.000000 cjm-yolox-pytorch-0.0.88/cjm_yolox_pytorch.egg-info/requires.txt
--rwxrwxrwx   0 innom-dt  (1000) innom-dt  (1000)       18 2023-07-13 07:54:31.000000 cjm-yolox-pytorch-0.0.88/cjm_yolox_pytorch.egg-info/top_level.txt
--rwxrwxrwx   0 innom-dt  (1000) innom-dt  (1000)     1067 2023-07-13 07:50:04.000000 cjm-yolox-pytorch-0.0.88/settings.ini
--rwxrwxrwx   0 innom-dt  (1000) innom-dt  (1000)       38 2023-07-13 07:54:32.000351 cjm-yolox-pytorch-0.0.88/setup.cfg
--rwxrwxrwx   0 innom-dt  (1000) innom-dt  (1000)     2596 2023-04-27 10:12:58.000000 cjm-yolox-pytorch-0.0.88/setup.py
...
### Comparing `cjm-yolox-pytorch-0.0.88/LICENSE` & `cjm-yolox-pytorch-0.0.9/LICENSE`

 * *Files identical despite different names*

### Comparing `cjm-yolox-pytorch-0.0.88/PKG-INFO` & `cjm-yolox-pytorch-0.0.9/PKG-INFO`
...
### Comparing `cjm-yolox-pytorch-0.0.88/README.md` & `cjm-yolox-pytorch-0.0.9/README.md`

 * *Files identical despite different names*

### Comparing `cjm-yolox-pytorch-0.0.88/cjm_yolox_pytorch/_modidx.py` & `cjm-yolox-pytorch-0.0.9/cjm_yolox_pytorch/_modidx.py`
...
### Comparing `cjm-yolox-pytorch-0.0.88/cjm_yolox_pytorch/loss.py` & `cjm-yolox-pytorch-0.0.9/cjm_yolox_pytorch/loss.py`
...
### Comparing `cjm-yolox-pytorch-0.0.88/cjm_yolox_pytorch/model.py` & `cjm-yolox-pytorch-0.0.9/cjm_yolox_pytorch/model.py`
...
### Comparing `cjm-yolox-pytorch-0.0.88/cjm_yolox_pytorch/simota.py` & `cjm-yolox-pytorch-0.0.9/cjm_yolox_pytorch/simota.py`
...
### Comparing `cjm-yolox-pytorch-0.0.88/cjm_yolox_pytorch.egg-info/PKG-INFO` & `cjm-yolox-pytorch-0.0.9/cjm_yolox_pytorch.egg-info/PKG-INFO`
...
### Comparing `cjm-yolox-pytorch-0.0.88/settings.ini` & `cjm-yolox-pytorch-0.0.9/settings.ini`
...
### Comparing `cjm-yolox-pytorch-0.0.88/setup.py` & `cjm-yolox-pytorch-0.0.9/setup.py`
