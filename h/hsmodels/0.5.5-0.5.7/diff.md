# Comparing `tmp/hsmodels-0.5.5.tar.gz` & `tmp/hsmodels-0.5.7.tar.gz`
...
### Comparing `hsmodels-0.5.5/hsmodels/schemas/rdf/validators.py` & `hsmodels-0.5.7/hsmodels/schemas/rdf/validators.py`
