# Comparing `tmp/idem-k8s-1.0.0.tar.gz` & `tmp/idem-k8s-1.0.1.tar.gz`
...
### Comparing `idem-k8s-1.0.0/idem_k8s/tool/k8s/core/v1/service_utils.py` & `idem-k8s-1.0.1/idem_k8s/tool/k8s/core/v1/service_utils.py`
