# Comparing `tmp/desim-tool-0.4.0.tar.gz` & `tmp/desim-tool-0.4.1.tar.gz`
...
+gzip compressed data, was "desim-tool-0.4.1.tar", last modified: Thu Jul 13 08:48:32 2023, max compression
```

## Comparing `desim-tool-0.4.0.tar` & `desim-tool-0.4.1.tar`
...
+drwxr-xr-x   0 oscarbennet   (501) staff       (20)        0 2023-07-13 08:48:32.686327 desim-tool-0.4.1/
+-rw-r--r--   0 oscarbennet   (501) staff       (20)     1089 2023-05-18 16:32:34.000000 desim-tool-0.4.1/LICENSE.md
+-rw-r--r--   0 oscarbennet   (501) staff       (20)      211 2023-07-13 08:48:32.686518 desim-tool-0.4.1/PKG-INFO
+-rw-r--r--   0 oscarbennet   (501) staff       (20)     1561 2023-05-18 16:32:34.000000 desim-tool-0.4.1/README.md
+drwxr-xr-x   0 oscarbennet   (501) staff       (20)        0 2023-07-13 08:48:32.682737 desim-tool-0.4.1/desim/
+-rw-r--r--   0 oscarbennet   (501) staff       (20)        0 2023-05-18 16:32:34.000000 desim-tool-0.4.1/desim/__init__.py
+-rw-r--r--   0 oscarbennet   (501) staff       (20)     2363 2023-05-18 16:32:34.000000 desim-tool-0.4.1/desim/data.py
+-rw-r--r--   0 oscarbennet   (501) staff       (20)      110 2023-07-01 12:22:15.000000 desim-tool-0.4.1/desim/helper.py
+-rw-r--r--   0 oscarbennet   (501) staff       (20)     7411 2023-07-13 08:28:04.000000 desim-tool-0.4.1/desim/interface.py
+-rw-r--r--   0 oscarbennet   (501) staff       (20)    10439 2023-07-01 12:22:15.000000 desim-tool-0.4.1/desim/simulation.py
+drwxr-xr-x   0 oscarbennet   (501) staff       (20)        0 2023-07-13 08:48:32.685618 desim-tool-0.4.1/desim_tool.egg-info/
+-rw-r--r--   0 oscarbennet   (501) staff       (20)      211 2023-07-13 08:48:32.000000 desim-tool-0.4.1/desim_tool.egg-info/PKG-INFO
+-rw-r--r--   0 oscarbennet   (501) staff       (20)      295 2023-07-13 08:48:32.000000 desim-tool-0.4.1/desim_tool.egg-info/SOURCES.txt
+-rw-r--r--   0 oscarbennet   (501) staff       (20)        1 2023-07-13 08:48:32.000000 desim-tool-0.4.1/desim_tool.egg-info/dependency_links.txt
+-rw-r--r--   0 oscarbennet   (501) staff       (20)       12 2023-07-13 08:48:32.000000 desim-tool-0.4.1/desim_tool.egg-info/requires.txt
+-rw-r--r--   0 oscarbennet   (501) staff       (20)        6 2023-07-13 08:48:32.000000 desim-tool-0.4.1/desim_tool.egg-info/top_level.txt
+-rw-r--r--   0 oscarbennet   (501) staff       (20)      106 2023-07-13 08:48:32.687579 desim-tool-0.4.1/setup.cfg
+-rw-r--r--   0 oscarbennet   (501) staff       (20)      284 2023-07-13 08:29:43.000000 desim-tool-0.4.1/setup.py
```

### Comparing `desim-tool-0.4.0/LICENSE.md` & `desim-tool-0.4.1/LICENSE.md`

 * *Files identical despite different names*

### Comparing `desim-tool-0.4.0/README.md` & `desim-tool-0.4.1/README.md`

 * *Files identical despite different names*

### Comparing `desim-tool-0.4.0/desim/data.py` & `desim-tool-0.4.1/desim/data.py`

 * *Files identical despite different names*

### Comparing `desim-tool-0.4.0/desim/interface.py` & `desim-tool-0.4.1/desim/interface.py`
...
### Comparing `desim-tool-0.4.0/desim/simulation.py` & `desim-tool-0.4.1/desim/simulation.py`
