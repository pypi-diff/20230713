# Comparing `tmp/gpt_index-0.7.6.tar.gz` & `tmp/gpt_index-0.7.7.tar.gz`
...
### Comparing `gpt_index-0.7.6/LICENSE` & `gpt_index-0.7.7/LICENSE`

 * *Files identical despite different names*

### Comparing `gpt_index-0.7.6/PKG-INFO` & `gpt_index-0.7.7/PKG-INFO`
...
### Comparing `gpt_index-0.7.6/README.md` & `gpt_index-0.7.7/README.md`

 * *Files identical despite different names*

### Comparing `gpt_index-0.7.6/gpt_index.egg-info/PKG-INFO` & `gpt_index-0.7.7/gpt_index.egg-info/PKG-INFO`
...
### Comparing `gpt_index-0.7.6/gpt_index.egg-info/SOURCES.txt` & `gpt_index-0.7.7/gpt_index.egg-info/SOURCES.txt`
...
### Comparing `gpt_index-0.7.6/llama_index/__init__.py` & `gpt_index-0.7.7/llama_index/__init__.py`

 * *Files identical despite different names*

### Comparing `gpt_index-0.7.6/llama_index/agent/context_retriever_agent.py` & `gpt_index-0.7.7/llama_index/agent/context_retriever_agent.py`
...
### Comparing `gpt_index-0.7.6/llama_index/agent/openai_agent.py` & `gpt_index-0.7.7/llama_index/agent/openai_agent.py`
...
### Comparing `gpt_index-0.7.6/llama_index/agent/react/base.py` & `gpt_index-0.7.7/llama_index/agent/react/base.py`

 * *Files identical despite different names*

### Comparing `gpt_index-0.7.6/llama_index/agent/react/formatter.py` & `gpt_index-0.7.7/llama_index/agent/react/formatter.py`

 * *Files identical despite different names*

### Comparing `gpt_index-0.7.6/llama_index/agent/react/output_parser.py` & `gpt_index-0.7.7/llama_index/agent/react/output_parser.py`

 * *Files identical despite different names*

### Comparing `gpt_index-0.7.6/llama_index/agent/react/prompts.py` & `gpt_index-0.7.7/llama_index/agent/react/prompts.py`

 * *Files identical despite different names*

### Comparing `gpt_index-0.7.6/llama_index/agent/react/types.py` & `gpt_index-0.7.7/llama_index/agent/react/types.py`

 * *Files identical despite different names*

### Comparing `gpt_index-0.7.6/llama_index/agent/retriever_openai_agent.py` & `gpt_index-0.7.7/llama_index/agent/retriever_openai_agent.py`
...
### Comparing `gpt_index-0.7.6/llama_index/agent/types.py` & `gpt_index-0.7.7/llama_index/agent/types.py`

 * *Files identical despite different names*

### Comparing `gpt_index-0.7.6/llama_index/async_utils.py` & `gpt_index-0.7.7/llama_index/async_utils.py`

 * *Files identical despite different names*

### Comparing `gpt_index-0.7.6/llama_index/bridge/langchain.py` & `gpt_index-0.7.7/llama_index/bridge/langchain.py`

 * *Files identical despite different names*

### Comparing `gpt_index-0.7.6/llama_index/callbacks/aim.py` & `gpt_index-0.7.7/llama_index/callbacks/aim.py`

 * *Files identical despite different names*

### Comparing `gpt_index-0.7.6/llama_index/callbacks/base.py` & `gpt_index-0.7.7/llama_index/callbacks/base.py`

 * *Files identical despite different names*

### Comparing `gpt_index-0.7.6/llama_index/callbacks/llama_debug.py` & `gpt_index-0.7.7/llama_index/callbacks/llama_debug.py`

 * *Files identical despite different names*

### Comparing `gpt_index-0.7.6/llama_index/callbacks/schema.py` & `gpt_index-0.7.7/llama_index/callbacks/schema.py`

 * *Files identical despite different names*

### Comparing `gpt_index-0.7.6/llama_index/callbacks/token_counting.py` & `gpt_index-0.7.7/llama_index/callbacks/token_counting.py`

 * *Files identical despite different names*

### Comparing `gpt_index-0.7.6/llama_index/callbacks/wandb_callback.py` & `gpt_index-0.7.7/llama_index/callbacks/wandb_callback.py`

 * *Files identical despite different names*

### Comparing `gpt_index-0.7.6/llama_index/chat_engine/condense_question.py` & `gpt_index-0.7.7/llama_index/chat_engine/condense_question.py`

 * *Files identical despite different names*

### Comparing `gpt_index-0.7.6/llama_index/chat_engine/simple.py` & `gpt_index-0.7.7/llama_index/chat_engine/simple.py`

 * *Files identical despite different names*

### Comparing `gpt_index-0.7.6/llama_index/chat_engine/types.py` & `gpt_index-0.7.7/llama_index/chat_engine/types.py`
...
### Comparing `gpt_index-0.7.6/llama_index/chat_engine/utils.py` & `gpt_index-0.7.7/llama_index/chat_engine/utils.py`

 * *Files identical despite different names*

### Comparing `gpt_index-0.7.6/llama_index/composability/joint_qa_summary.py` & `gpt_index-0.7.7/llama_index/composability/joint_qa_summary.py`

 * *Files identical despite different names*

### Comparing `gpt_index-0.7.6/llama_index/data_structs/data_structs.py` & `gpt_index-0.7.7/llama_index/data_structs/data_structs.py`

 * *Files identical despite different names*

### Comparing `gpt_index-0.7.6/llama_index/data_structs/document_summary.py` & `gpt_index-0.7.7/llama_index/data_structs/document_summary.py`

 * *Files identical despite different names*

### Comparing `gpt_index-0.7.6/llama_index/data_structs/registry.py` & `gpt_index-0.7.7/llama_index/data_structs/registry.py`

 * *Files identical despite different names*

### Comparing `gpt_index-0.7.6/llama_index/data_structs/struct_type.py` & `gpt_index-0.7.7/llama_index/data_structs/struct_type.py`

 * *Files identical despite different names*

### Comparing `gpt_index-0.7.6/llama_index/data_structs/table.py` & `gpt_index-0.7.7/llama_index/data_structs/table.py`

 * *Files identical despite different names*

### Comparing `gpt_index-0.7.6/llama_index/embeddings/base.py` & `gpt_index-0.7.7/llama_index/embeddings/base.py`

 * *Files identical despite different names*

### Comparing `gpt_index-0.7.6/llama_index/embeddings/google.py` & `gpt_index-0.7.7/llama_index/embeddings/google.py`

 * *Files identical despite different names*

### Comparing `gpt_index-0.7.6/llama_index/embeddings/langchain.py` & `gpt_index-0.7.7/llama_index/embeddings/langchain.py`

 * *Files identical despite different names*

### Comparing `gpt_index-0.7.6/llama_index/embeddings/openai.py` & `gpt_index-0.7.7/llama_index/embeddings/openai.py`

 * *Files identical despite different names*

### Comparing `gpt_index-0.7.6/llama_index/embeddings/utils.py` & `gpt_index-0.7.7/llama_index/embeddings/utils.py`

 * *Files identical despite different names*

### Comparing `gpt_index-0.7.6/llama_index/evaluation/base.py` & `gpt_index-0.7.7/llama_index/evaluation/base.py`

 * *Files identical despite different names*

### Comparing `gpt_index-0.7.6/llama_index/evaluation/dataset_generation.py` & `gpt_index-0.7.7/llama_index/evaluation/dataset_generation.py`

 * *Files identical despite different names*

### Comparing `gpt_index-0.7.6/llama_index/evaluation/guideline_eval.py` & `gpt_index-0.7.7/llama_index/evaluation/guideline_eval.py`

 * *Files identical despite different names*

### Comparing `gpt_index-0.7.6/llama_index/graph_stores/nebulagraph.py` & `gpt_index-0.7.7/llama_index/graph_stores/nebulagraph.py`
...
### Comparing `gpt_index-0.7.6/llama_index/graph_stores/registery.py` & `gpt_index-0.7.7/llama_index/graph_stores/registery.py`

 * *Files identical despite different names*

### Comparing `gpt_index-0.7.6/llama_index/graph_stores/simple.py` & `gpt_index-0.7.7/llama_index/graph_stores/simple.py`
...
### Comparing `gpt_index-0.7.6/llama_index/graph_stores/types.py` & `gpt_index-0.7.7/llama_index/graph_stores/types.py`
...
### Comparing `gpt_index-0.7.6/llama_index/img_utils.py` & `gpt_index-0.7.7/llama_index/img_utils.py`

 * *Files identical despite different names*

### Comparing `gpt_index-0.7.6/llama_index/indices/__init__.py` & `gpt_index-0.7.7/llama_index/indices/__init__.py`

 * *Files identical despite different names*

### Comparing `gpt_index-0.7.6/llama_index/indices/base.py` & `gpt_index-0.7.7/llama_index/indices/base.py`
...
### Comparing `gpt_index-0.7.6/llama_index/indices/base_retriever.py` & `gpt_index-0.7.7/llama_index/indices/base_retriever.py`

 * *Files identical despite different names*

### Comparing `gpt_index-0.7.6/llama_index/indices/common/struct_store/base.py` & `gpt_index-0.7.7/llama_index/indices/common/struct_store/base.py`

 * *Files identical despite different names*

### Comparing `gpt_index-0.7.6/llama_index/indices/common/struct_store/schema.py` & `gpt_index-0.7.7/llama_index/indices/common/struct_store/schema.py`

 * *Files identical despite different names*

### Comparing `gpt_index-0.7.6/llama_index/indices/common/struct_store/sql.py` & `gpt_index-0.7.7/llama_index/indices/common/struct_store/sql.py`

 * *Files identical despite different names*

### Comparing `gpt_index-0.7.6/llama_index/indices/common_tree/base.py` & `gpt_index-0.7.7/llama_index/indices/common_tree/base.py`

 * *Files identical despite different names*

### Comparing `gpt_index-0.7.6/llama_index/indices/composability/graph.py` & `gpt_index-0.7.7/llama_index/indices/composability/graph.py`

 * *Files identical despite different names*

### Comparing `gpt_index-0.7.6/llama_index/indices/document_summary/base.py` & `gpt_index-0.7.7/llama_index/indices/document_summary/base.py`

 * *Files identical despite different names*

### Comparing `gpt_index-0.7.6/llama_index/indices/document_summary/retrievers.py` & `gpt_index-0.7.7/llama_index/indices/document_summary/retrievers.py`

 * *Files identical despite different names*

### Comparing `gpt_index-0.7.6/llama_index/indices/empty/base.py` & `gpt_index-0.7.7/llama_index/indices/empty/base.py`

 * *Files identical despite different names*

### Comparing `gpt_index-0.7.6/llama_index/indices/empty/retrievers.py` & `gpt_index-0.7.7/llama_index/indices/empty/retrievers.py`

 * *Files identical despite different names*

### Comparing `gpt_index-0.7.6/llama_index/indices/keyword_table/__init__.py` & `gpt_index-0.7.7/llama_index/indices/keyword_table/__init__.py`

 * *Files identical despite different names*

### Comparing `gpt_index-0.7.6/llama_index/indices/keyword_table/base.py` & `gpt_index-0.7.7/llama_index/indices/keyword_table/base.py`

 * *Files identical despite different names*

### Comparing `gpt_index-0.7.6/llama_index/indices/keyword_table/rake_base.py` & `gpt_index-0.7.7/llama_index/indices/keyword_table/rake_base.py`

 * *Files identical despite different names*

### Comparing `gpt_index-0.7.6/llama_index/indices/keyword_table/retrievers.py` & `gpt_index-0.7.7/llama_index/indices/keyword_table/retrievers.py`

 * *Files identical despite different names*

### Comparing `gpt_index-0.7.6/llama_index/indices/keyword_table/simple_base.py` & `gpt_index-0.7.7/llama_index/indices/keyword_table/simple_base.py`

 * *Files identical despite different names*

### Comparing `gpt_index-0.7.6/llama_index/indices/keyword_table/utils.py` & `gpt_index-0.7.7/llama_index/indices/keyword_table/utils.py`

 * *Files identical despite different names*

### Comparing `gpt_index-0.7.6/llama_index/indices/knowledge_graph/base.py` & `gpt_index-0.7.7/llama_index/indices/knowledge_graph/base.py`

 * *Files identical despite different names*

### Comparing `gpt_index-0.7.6/llama_index/indices/knowledge_graph/retriever.py` & `gpt_index-0.7.7/llama_index/indices/knowledge_graph/retriever.py`

 * *Files identical despite different names*

### Comparing `gpt_index-0.7.6/llama_index/indices/list/base.py` & `gpt_index-0.7.7/llama_index/indices/list/base.py`

 * *Files identical despite different names*

### Comparing `gpt_index-0.7.6/llama_index/indices/list/retrievers.py` & `gpt_index-0.7.7/llama_index/indices/list/retrievers.py`

 * *Files identical despite different names*

### Comparing `gpt_index-0.7.6/llama_index/indices/loading.py` & `gpt_index-0.7.7/llama_index/indices/loading.py`

 * *Files identical despite different names*

### Comparing `gpt_index-0.7.6/llama_index/indices/postprocessor/__init__.py` & `gpt_index-0.7.7/llama_index/indices/postprocessor/__init__.py`

 * *Files identical despite different names*

### Comparing `gpt_index-0.7.6/llama_index/indices/postprocessor/cohere_rerank.py` & `gpt_index-0.7.7/llama_index/indices/postprocessor/cohere_rerank.py`

 * *Files identical despite different names*

### Comparing `gpt_index-0.7.6/llama_index/indices/postprocessor/llm_rerank.py` & `gpt_index-0.7.7/llama_index/indices/postprocessor/llm_rerank.py`

 * *Files identical despite different names*

### Comparing `gpt_index-0.7.6/llama_index/indices/postprocessor/node.py` & `gpt_index-0.7.7/llama_index/indices/postprocessor/node.py`

 * *Files identical despite different names*

### Comparing `gpt_index-0.7.6/llama_index/indices/postprocessor/node_recency.py` & `gpt_index-0.7.7/llama_index/indices/postprocessor/node_recency.py`

 * *Files identical despite different names*

### Comparing `gpt_index-0.7.6/llama_index/indices/postprocessor/optimizer.py` & `gpt_index-0.7.7/llama_index/indices/postprocessor/optimizer.py`

 * *Files identical despite different names*

### Comparing `gpt_index-0.7.6/llama_index/indices/postprocessor/pii.py` & `gpt_index-0.7.7/llama_index/indices/postprocessor/pii.py`

 * *Files identical despite different names*

### Comparing `gpt_index-0.7.6/llama_index/indices/prompt_helper.py` & `gpt_index-0.7.7/llama_index/indices/prompt_helper.py`

 * *Files identical despite different names*

### Comparing `gpt_index-0.7.6/llama_index/indices/query/base.py` & `gpt_index-0.7.7/llama_index/indices/query/base.py`

 * *Files identical despite different names*

### Comparing `gpt_index-0.7.6/llama_index/indices/query/embedding_utils.py` & `gpt_index-0.7.7/llama_index/indices/query/embedding_utils.py`

 * *Files identical despite different names*

### Comparing `gpt_index-0.7.6/llama_index/indices/query/query_transform/base.py` & `gpt_index-0.7.7/llama_index/indices/query/query_transform/base.py`

 * *Files identical despite different names*

### Comparing `gpt_index-0.7.6/llama_index/indices/query/query_transform/feedback_transform.py` & `gpt_index-0.7.7/llama_index/indices/query/query_transform/feedback_transform.py`

 * *Files identical despite different names*

### Comparing `gpt_index-0.7.6/llama_index/indices/query/query_transform/prompts.py` & `gpt_index-0.7.7/llama_index/indices/query/query_transform/prompts.py`

 * *Files identical despite different names*

### Comparing `gpt_index-0.7.6/llama_index/indices/query/schema.py` & `gpt_index-0.7.7/llama_index/indices/query/schema.py`

 * *Files identical despite different names*

### Comparing `gpt_index-0.7.6/llama_index/indices/registry.py` & `gpt_index-0.7.7/llama_index/indices/registry.py`

 * *Files identical despite different names*

### Comparing `gpt_index-0.7.6/llama_index/indices/service_context.py` & `gpt_index-0.7.7/llama_index/indices/service_context.py`
...
### Comparing `gpt_index-0.7.6/llama_index/indices/struct_store/__init__.py` & `gpt_index-0.7.7/llama_index/indices/struct_store/__init__.py`

 * *Files identical despite different names*

### Comparing `gpt_index-0.7.6/llama_index/indices/struct_store/base.py` & `gpt_index-0.7.7/llama_index/indices/struct_store/base.py`

 * *Files identical despite different names*

### Comparing `gpt_index-0.7.6/llama_index/indices/struct_store/container_builder.py` & `gpt_index-0.7.7/llama_index/indices/struct_store/container_builder.py`

 * *Files identical despite different names*

### Comparing `gpt_index-0.7.6/llama_index/indices/struct_store/json_query.py` & `gpt_index-0.7.7/llama_index/indices/struct_store/json_query.py`

 * *Files identical despite different names*

### Comparing `gpt_index-0.7.6/llama_index/indices/struct_store/pandas.py` & `gpt_index-0.7.7/llama_index/indices/struct_store/pandas.py`

 * *Files identical despite different names*

### Comparing `gpt_index-0.7.6/llama_index/indices/struct_store/sql.py` & `gpt_index-0.7.7/llama_index/indices/struct_store/sql.py`

 * *Files identical despite different names*

### Comparing `gpt_index-0.7.6/llama_index/indices/struct_store/sql_query.py` & `gpt_index-0.7.7/llama_index/indices/struct_store/sql_query.py`

 * *Files identical despite different names*

### Comparing `gpt_index-0.7.6/llama_index/indices/tree/__init__.py` & `gpt_index-0.7.7/llama_index/indices/tree/__init__.py`

 * *Files identical despite different names*

### Comparing `gpt_index-0.7.6/llama_index/indices/tree/all_leaf_retriever.py` & `gpt_index-0.7.7/llama_index/indices/tree/all_leaf_retriever.py`

 * *Files identical despite different names*

### Comparing `gpt_index-0.7.6/llama_index/indices/tree/base.py` & `gpt_index-0.7.7/llama_index/indices/tree/base.py`

 * *Files identical despite different names*

### Comparing `gpt_index-0.7.6/llama_index/indices/tree/inserter.py` & `gpt_index-0.7.7/llama_index/indices/tree/inserter.py`

 * *Files identical despite different names*

### Comparing `gpt_index-0.7.6/llama_index/indices/tree/select_leaf_embedding_retriever.py` & `gpt_index-0.7.7/llama_index/indices/tree/select_leaf_embedding_retriever.py`

 * *Files identical despite different names*

### Comparing `gpt_index-0.7.6/llama_index/indices/tree/select_leaf_retriever.py` & `gpt_index-0.7.7/llama_index/indices/tree/select_leaf_retriever.py`

 * *Files identical despite different names*

### Comparing `gpt_index-0.7.6/llama_index/indices/tree/tree_root_retriever.py` & `gpt_index-0.7.7/llama_index/indices/tree/tree_root_retriever.py`

 * *Files identical despite different names*

### Comparing `gpt_index-0.7.6/llama_index/indices/tree/utils.py` & `gpt_index-0.7.7/llama_index/indices/tree/utils.py`

 * *Files identical despite different names*

### Comparing `gpt_index-0.7.6/llama_index/indices/utils.py` & `gpt_index-0.7.7/llama_index/indices/utils.py`

 * *Files identical despite different names*

### Comparing `gpt_index-0.7.6/llama_index/indices/vector_store/base.py` & `gpt_index-0.7.7/llama_index/indices/vector_store/base.py`

 * *Files identical despite different names*

### Comparing `gpt_index-0.7.6/llama_index/indices/vector_store/retrievers/auto_retriever/auto_retriever.py` & `gpt_index-0.7.7/llama_index/indices/vector_store/retrievers/auto_retriever/auto_retriever.py`

 * *Files identical despite different names*

### Comparing `gpt_index-0.7.6/llama_index/indices/vector_store/retrievers/auto_retriever/output_parser.py` & `gpt_index-0.7.7/llama_index/indices/vector_store/retrievers/auto_retriever/output_parser.py`

 * *Files identical despite different names*

### Comparing `gpt_index-0.7.6/llama_index/indices/vector_store/retrievers/auto_retriever/prompts.py` & `gpt_index-0.7.7/llama_index/indices/vector_store/retrievers/auto_retriever/prompts.py`

 * *Files identical despite different names*

### Comparing `gpt_index-0.7.6/llama_index/indices/vector_store/retrievers/retriever.py` & `gpt_index-0.7.7/llama_index/indices/vector_store/retrievers/retriever.py`

 * *Files identical despite different names*

### Comparing `gpt_index-0.7.6/llama_index/langchain_helpers/agents/__init__.py` & `gpt_index-0.7.7/llama_index/langchain_helpers/agents/__init__.py`

 * *Files identical despite different names*

### Comparing `gpt_index-0.7.6/llama_index/langchain_helpers/agents/agents.py` & `gpt_index-0.7.7/llama_index/langchain_helpers/agents/agents.py`

 * *Files identical despite different names*

### Comparing `gpt_index-0.7.6/llama_index/langchain_helpers/agents/toolkits.py` & `gpt_index-0.7.7/llama_index/langchain_helpers/agents/toolkits.py`

 * *Files identical despite different names*

### Comparing `gpt_index-0.7.6/llama_index/langchain_helpers/agents/tools.py` & `gpt_index-0.7.7/llama_index/langchain_helpers/agents/tools.py`

 * *Files identical despite different names*

### Comparing `gpt_index-0.7.6/llama_index/langchain_helpers/memory_wrapper.py` & `gpt_index-0.7.7/llama_index/langchain_helpers/memory_wrapper.py`

 * *Files identical despite different names*

### Comparing `gpt_index-0.7.6/llama_index/langchain_helpers/sql_wrapper.py` & `gpt_index-0.7.7/llama_index/langchain_helpers/sql_wrapper.py`

 * *Files identical despite different names*

### Comparing `gpt_index-0.7.6/llama_index/langchain_helpers/streaming.py` & `gpt_index-0.7.7/llama_index/langchain_helpers/streaming.py`

 * *Files identical despite different names*

### Comparing `gpt_index-0.7.6/llama_index/langchain_helpers/text_splitter.py` & `gpt_index-0.7.7/llama_index/langchain_helpers/text_splitter.py`

 * *Files identical despite different names*

### Comparing `gpt_index-0.7.6/llama_index/llm_predictor/base.py` & `gpt_index-0.7.7/llama_index/llm_predictor/base.py`

 * *Files identical despite different names*

### Comparing `gpt_index-0.7.6/llama_index/llm_predictor/mock.py` & `gpt_index-0.7.7/llama_index/llm_predictor/mock.py`

 * *Files identical despite different names*

### Comparing `gpt_index-0.7.6/llama_index/llm_predictor/structured.py` & `gpt_index-0.7.7/llama_index/llm_predictor/structured.py`

 * *Files identical despite different names*

### Comparing `gpt_index-0.7.6/llama_index/llm_predictor/utils.py` & `gpt_index-0.7.7/llama_index/llm_predictor/utils.py`

 * *Files identical despite different names*

### Comparing `gpt_index-0.7.6/llama_index/llm_predictor/vellum/predictor.py` & `gpt_index-0.7.7/llama_index/llm_predictor/vellum/predictor.py`

 * *Files identical despite different names*

### Comparing `gpt_index-0.7.6/llama_index/llm_predictor/vellum/prompt_registry.py` & `gpt_index-0.7.7/llama_index/llm_predictor/vellum/prompt_registry.py`

 * *Files identical despite different names*

### Comparing `gpt_index-0.7.6/llama_index/llm_predictor/vellum/types.py` & `gpt_index-0.7.7/llama_index/llm_predictor/vellum/types.py`

 * *Files identical despite different names*

### Comparing `gpt_index-0.7.6/llama_index/llms/__init__.py` & `gpt_index-0.7.7/llama_index/llms/__init__.py`

 * *Files identical despite different names*

### Comparing `gpt_index-0.7.6/llama_index/llms/anthropic.py` & `gpt_index-0.7.7/llama_index/llms/anthropic.py`

 * *Files identical despite different names*

### Comparing `gpt_index-0.7.6/llama_index/llms/anthropic_utils.py` & `gpt_index-0.7.7/llama_index/llms/anthropic_utils.py`

 * *Files identical despite different names*

### Comparing `gpt_index-0.7.6/llama_index/llms/azure_openai.py` & `gpt_index-0.7.7/llama_index/llms/azure_openai.py`

 * *Files identical despite different names*

### Comparing `gpt_index-0.7.6/llama_index/llms/base.py` & `gpt_index-0.7.7/llama_index/llms/base.py`
...
### Comparing `gpt_index-0.7.6/llama_index/llms/custom.py` & `gpt_index-0.7.7/llama_index/llms/custom.py`

 * *Files identical despite different names*

### Comparing `gpt_index-0.7.6/llama_index/llms/generic_utils.py` & `gpt_index-0.7.7/llama_index/llms/generic_utils.py`

 * *Files identical despite different names*

### Comparing `gpt_index-0.7.6/llama_index/llms/huggingface.py` & `gpt_index-0.7.7/llama_index/llms/huggingface.py`

 * *Files identical despite different names*

### Comparing `gpt_index-0.7.6/llama_index/llms/langchain.py` & `gpt_index-0.7.7/llama_index/llms/langchain.py`

 * *Files identical despite different names*

### Comparing `gpt_index-0.7.6/llama_index/llms/langchain_utils.py` & `gpt_index-0.7.7/llama_index/llms/langchain_utils.py`

 * *Files identical despite different names*

### Comparing `gpt_index-0.7.6/llama_index/llms/mock.py` & `gpt_index-0.7.7/llama_index/llms/mock.py`

 * *Files identical despite different names*

### Comparing `gpt_index-0.7.6/llama_index/llms/openai.py` & `gpt_index-0.7.7/llama_index/llms/openai.py`

 * *Files identical despite different names*

### Comparing `gpt_index-0.7.6/llama_index/llms/openai_utils.py` & `gpt_index-0.7.7/llama_index/llms/openai_utils.py`
...
### Comparing `gpt_index-0.7.6/llama_index/llms/palm.py` & `gpt_index-0.7.7/llama_index/llms/palm.py`

 * *Files identical despite different names*

### Comparing `gpt_index-0.7.6/llama_index/logger/base.py` & `gpt_index-0.7.7/llama_index/logger/base.py`

 * *Files identical despite different names*

### Comparing `gpt_index-0.7.6/llama_index/memory/chat_memory_buffer.py` & `gpt_index-0.7.7/llama_index/memory/chat_memory_buffer.py`

 * *Files identical despite different names*

### Comparing `gpt_index-0.7.6/llama_index/memory/types.py` & `gpt_index-0.7.7/llama_index/memory/types.py`

 * *Files identical despite different names*

### Comparing `gpt_index-0.7.6/llama_index/node_parser/extractors/metadata_extractors.py` & `gpt_index-0.7.7/llama_index/node_parser/extractors/metadata_extractors.py`

 * *Files identical despite different names*

### Comparing `gpt_index-0.7.6/llama_index/node_parser/interface.py` & `gpt_index-0.7.7/llama_index/node_parser/interface.py`

 * *Files identical despite different names*

### Comparing `gpt_index-0.7.6/llama_index/node_parser/node_utils.py` & `gpt_index-0.7.7/llama_index/node_parser/node_utils.py`

 * *Files identical despite different names*

### Comparing `gpt_index-0.7.6/llama_index/node_parser/simple.py` & `gpt_index-0.7.7/llama_index/node_parser/simple.py`

 * *Files identical despite different names*

### Comparing `gpt_index-0.7.6/llama_index/objects/__init__.py` & `gpt_index-0.7.7/llama_index/objects/__init__.py`

 * *Files identical despite different names*

### Comparing `gpt_index-0.7.6/llama_index/objects/base.py` & `gpt_index-0.7.7/llama_index/objects/base.py`

 * *Files identical despite different names*

### Comparing `gpt_index-0.7.6/llama_index/objects/base_node_mapping.py` & `gpt_index-0.7.7/llama_index/objects/base_node_mapping.py`

 * *Files identical despite different names*

### Comparing `gpt_index-0.7.6/llama_index/objects/table_node_mapping.py` & `gpt_index-0.7.7/llama_index/objects/table_node_mapping.py`

 * *Files identical despite different names*

### Comparing `gpt_index-0.7.6/llama_index/objects/tool_node_mapping.py` & `gpt_index-0.7.7/llama_index/objects/tool_node_mapping.py`

 * *Files identical despite different names*

### Comparing `gpt_index-0.7.6/llama_index/output_parsers/guardrails.py` & `gpt_index-0.7.7/llama_index/output_parsers/guardrails.py`

 * *Files identical despite different names*

### Comparing `gpt_index-0.7.6/llama_index/output_parsers/langchain.py` & `gpt_index-0.7.7/llama_index/output_parsers/langchain.py`

 * *Files identical despite different names*

### Comparing `gpt_index-0.7.6/llama_index/output_parsers/pydantic.py` & `gpt_index-0.7.7/llama_index/output_parsers/pydantic.py`

 * *Files identical despite different names*

### Comparing `gpt_index-0.7.6/llama_index/output_parsers/selection.py` & `gpt_index-0.7.7/llama_index/output_parsers/selection.py`

 * *Files identical despite different names*

### Comparing `gpt_index-0.7.6/llama_index/output_parsers/utils.py` & `gpt_index-0.7.7/llama_index/output_parsers/utils.py`

 * *Files identical despite different names*

### Comparing `gpt_index-0.7.6/llama_index/playground/base.py` & `gpt_index-0.7.7/llama_index/playground/base.py`

 * *Files identical despite different names*

### Comparing `gpt_index-0.7.6/llama_index/program/__init__.py` & `gpt_index-0.7.7/llama_index/program/__init__.py`

 * *Files identical despite different names*

### Comparing `gpt_index-0.7.6/llama_index/program/guidance_program.py` & `gpt_index-0.7.7/llama_index/program/guidance_program.py`

 * *Files identical despite different names*

### Comparing `gpt_index-0.7.6/llama_index/program/llm_program.py` & `gpt_index-0.7.7/llama_index/program/llm_program.py`

 * *Files identical despite different names*

### Comparing `gpt_index-0.7.6/llama_index/program/llm_prompt_program.py` & `gpt_index-0.7.7/llama_index/program/llm_prompt_program.py`

 * *Files identical despite different names*

### Comparing `gpt_index-0.7.6/llama_index/program/openai_program.py` & `gpt_index-0.7.7/llama_index/program/openai_program.py`
...
### Comparing `gpt_index-0.7.6/llama_index/program/predefined/df.py` & `gpt_index-0.7.7/llama_index/program/predefined/df.py`

 * *Files identical despite different names*

### Comparing `gpt_index-0.7.6/llama_index/program/predefined/evaporate/base.py` & `gpt_index-0.7.7/llama_index/program/predefined/evaporate/base.py`

 * *Files identical despite different names*

### Comparing `gpt_index-0.7.6/llama_index/program/predefined/evaporate/extractor.py` & `gpt_index-0.7.7/llama_index/program/predefined/evaporate/extractor.py`

 * *Files identical despite different names*

### Comparing `gpt_index-0.7.6/llama_index/program/predefined/evaporate/prompts.py` & `gpt_index-0.7.7/llama_index/program/predefined/evaporate/prompts.py`

 * *Files identical despite different names*

### Comparing `gpt_index-0.7.6/llama_index/prompts/base.py` & `gpt_index-0.7.7/llama_index/prompts/base.py`

 * *Files identical despite different names*

### Comparing `gpt_index-0.7.6/llama_index/prompts/chat_prompts.py` & `gpt_index-0.7.7/llama_index/prompts/chat_prompts.py`

 * *Files identical despite different names*

### Comparing `gpt_index-0.7.6/llama_index/prompts/choice_select.py` & `gpt_index-0.7.7/llama_index/prompts/choice_select.py`

 * *Files identical despite different names*

### Comparing `gpt_index-0.7.6/llama_index/prompts/default_prompt_selectors.py` & `gpt_index-0.7.7/llama_index/prompts/default_prompt_selectors.py`

 * *Files identical despite different names*

### Comparing `gpt_index-0.7.6/llama_index/prompts/default_prompts.py` & `gpt_index-0.7.7/llama_index/prompts/default_prompts.py`

 * *Files identical despite different names*

### Comparing `gpt_index-0.7.6/llama_index/prompts/guidance_utils.py` & `gpt_index-0.7.7/llama_index/prompts/guidance_utils.py`

 * *Files identical despite different names*

### Comparing `gpt_index-0.7.6/llama_index/prompts/prompt_selector.py` & `gpt_index-0.7.7/llama_index/prompts/prompt_selector.py`

 * *Files identical despite different names*

### Comparing `gpt_index-0.7.6/llama_index/prompts/prompt_type.py` & `gpt_index-0.7.7/llama_index/prompts/prompt_type.py`
...
### Comparing `gpt_index-0.7.6/llama_index/prompts/prompts.py` & `gpt_index-0.7.7/llama_index/prompts/prompts.py`

 * *Files identical despite different names*

### Comparing `gpt_index-0.7.6/llama_index/prompts/system.py` & `gpt_index-0.7.7/llama_index/prompts/system.py`

 * *Files identical despite different names*

### Comparing `gpt_index-0.7.6/llama_index/prompts/utils.py` & `gpt_index-0.7.7/llama_index/prompts/utils.py`

 * *Files identical despite different names*

### Comparing `gpt_index-0.7.6/llama_index/query_engine/__init__.py` & `gpt_index-0.7.7/llama_index/query_engine/__init__.py`
...
### Comparing `gpt_index-0.7.6/llama_index/query_engine/citation_query_engine.py` & `gpt_index-0.7.7/llama_index/query_engine/citation_query_engine.py`

 * *Files identical despite different names*

### Comparing `gpt_index-0.7.6/llama_index/query_engine/flare/answer_inserter.py` & `gpt_index-0.7.7/llama_index/query_engine/flare/answer_inserter.py`

 * *Files identical despite different names*

### Comparing `gpt_index-0.7.6/llama_index/query_engine/flare/base.py` & `gpt_index-0.7.7/llama_index/query_engine/flare/base.py`

 * *Files identical despite different names*

### Comparing `gpt_index-0.7.6/llama_index/query_engine/flare/output_parser.py` & `gpt_index-0.7.7/llama_index/query_engine/flare/output_parser.py`

 * *Files identical despite different names*

### Comparing `gpt_index-0.7.6/llama_index/query_engine/graph_query_engine.py` & `gpt_index-0.7.7/llama_index/query_engine/graph_query_engine.py`

 * *Files identical despite different names*

### Comparing `gpt_index-0.7.6/llama_index/query_engine/multistep_query_engine.py` & `gpt_index-0.7.7/llama_index/query_engine/multistep_query_engine.py`

 * *Files identical despite different names*

### Comparing `gpt_index-0.7.6/llama_index/query_engine/pandas_query_engine.py` & `gpt_index-0.7.7/llama_index/query_engine/pandas_query_engine.py`

 * *Files identical despite different names*

### Comparing `gpt_index-0.7.6/llama_index/query_engine/retriever_query_engine.py` & `gpt_index-0.7.7/llama_index/query_engine/retriever_query_engine.py`

 * *Files identical despite different names*

### Comparing `gpt_index-0.7.6/llama_index/query_engine/retry_query_engine.py` & `gpt_index-0.7.7/llama_index/query_engine/retry_query_engine.py`

 * *Files identical despite different names*

### Comparing `gpt_index-0.7.6/llama_index/query_engine/retry_source_query_engine.py` & `gpt_index-0.7.7/llama_index/query_engine/retry_source_query_engine.py`

 * *Files identical despite different names*

### Comparing `gpt_index-0.7.6/llama_index/query_engine/router_query_engine.py` & `gpt_index-0.7.7/llama_index/query_engine/router_query_engine.py`

 * *Files identical despite different names*

### Comparing `gpt_index-0.7.6/llama_index/query_engine/sql_join_query_engine.py` & `gpt_index-0.7.7/llama_index/query_engine/sql_join_query_engine.py`

 * *Files identical despite different names*

### Comparing `gpt_index-0.7.6/llama_index/query_engine/sql_vector_query_engine.py` & `gpt_index-0.7.7/llama_index/query_engine/sql_vector_query_engine.py`

 * *Files identical despite different names*

### Comparing `gpt_index-0.7.6/llama_index/query_engine/sub_question_query_engine.py` & `gpt_index-0.7.7/llama_index/query_engine/sub_question_query_engine.py`

 * *Files identical despite different names*

### Comparing `gpt_index-0.7.6/llama_index/query_engine/transform_query_engine.py` & `gpt_index-0.7.7/llama_index/query_engine/transform_query_engine.py`

 * *Files identical despite different names*

### Comparing `gpt_index-0.7.6/llama_index/question_gen/guidance_generator.py` & `gpt_index-0.7.7/llama_index/question_gen/guidance_generator.py`

 * *Files identical despite different names*

### Comparing `gpt_index-0.7.6/llama_index/question_gen/llm_generators.py` & `gpt_index-0.7.7/llama_index/question_gen/llm_generators.py`

 * *Files identical despite different names*

### Comparing `gpt_index-0.7.6/llama_index/question_gen/output_parser.py` & `gpt_index-0.7.7/llama_index/question_gen/output_parser.py`

 * *Files identical despite different names*

### Comparing `gpt_index-0.7.6/llama_index/question_gen/prompts.py` & `gpt_index-0.7.7/llama_index/question_gen/prompts.py`

 * *Files identical despite different names*

### Comparing `gpt_index-0.7.6/llama_index/question_gen/types.py` & `gpt_index-0.7.7/llama_index/question_gen/types.py`

 * *Files identical despite different names*

### Comparing `gpt_index-0.7.6/llama_index/readers/__init__.py` & `gpt_index-0.7.7/llama_index/readers/__init__.py`

 * *Files identical despite different names*

### Comparing `gpt_index-0.7.6/llama_index/readers/base.py` & `gpt_index-0.7.7/llama_index/readers/base.py`

 * *Files identical despite different names*

### Comparing `gpt_index-0.7.6/llama_index/readers/chatgpt_plugin/base.py` & `gpt_index-0.7.7/llama_index/readers/chatgpt_plugin/base.py`

 * *Files identical despite different names*

### Comparing `gpt_index-0.7.6/llama_index/readers/chroma.py` & `gpt_index-0.7.7/llama_index/readers/chroma.py`

 * *Files identical despite different names*

### Comparing `gpt_index-0.7.6/llama_index/readers/database.py` & `gpt_index-0.7.7/llama_index/readers/database.py`

 * *Files identical despite different names*

### Comparing `gpt_index-0.7.6/llama_index/readers/deeplake.py` & `gpt_index-0.7.7/llama_index/readers/deeplake.py`

 * *Files identical despite different names*

### Comparing `gpt_index-0.7.6/llama_index/readers/discord_reader.py` & `gpt_index-0.7.7/llama_index/readers/discord_reader.py`

 * *Files identical despite different names*

### Comparing `gpt_index-0.7.6/llama_index/readers/download.py` & `gpt_index-0.7.7/llama_index/readers/download.py`

 * *Files identical despite different names*

### Comparing `gpt_index-0.7.6/llama_index/readers/elasticsearch.py` & `gpt_index-0.7.7/llama_index/readers/elasticsearch.py`

 * *Files identical despite different names*

### Comparing `gpt_index-0.7.6/llama_index/readers/faiss.py` & `gpt_index-0.7.7/llama_index/readers/faiss.py`

 * *Files identical despite different names*

### Comparing `gpt_index-0.7.6/llama_index/readers/file/base.py` & `gpt_index-0.7.7/llama_index/readers/file/base.py`

 * *Files identical despite different names*

### Comparing `gpt_index-0.7.6/llama_index/readers/file/docs_reader.py` & `gpt_index-0.7.7/llama_index/readers/file/docs_reader.py`

 * *Files identical despite different names*

### Comparing `gpt_index-0.7.6/llama_index/readers/file/epub_reader.py` & `gpt_index-0.7.7/llama_index/readers/file/epub_reader.py`

 * *Files identical despite different names*

### Comparing `gpt_index-0.7.6/llama_index/readers/file/image_caption_reader.py` & `gpt_index-0.7.7/llama_index/readers/file/image_caption_reader.py`

 * *Files identical despite different names*

### Comparing `gpt_index-0.7.6/llama_index/readers/file/image_reader.py` & `gpt_index-0.7.7/llama_index/readers/file/image_reader.py`

 * *Files identical despite different names*

### Comparing `gpt_index-0.7.6/llama_index/readers/file/image_vision_llm_reader.py` & `gpt_index-0.7.7/llama_index/readers/file/image_vision_llm_reader.py`

 * *Files identical despite different names*

### Comparing `gpt_index-0.7.6/llama_index/readers/file/ipynb_reader.py` & `gpt_index-0.7.7/llama_index/readers/file/ipynb_reader.py`

 * *Files identical despite different names*

### Comparing `gpt_index-0.7.6/llama_index/readers/file/markdown_reader.py` & `gpt_index-0.7.7/llama_index/readers/file/markdown_reader.py`

 * *Files identical despite different names*

### Comparing `gpt_index-0.7.6/llama_index/readers/file/mbox_reader.py` & `gpt_index-0.7.7/llama_index/readers/file/mbox_reader.py`

 * *Files identical despite different names*

### Comparing `gpt_index-0.7.6/llama_index/readers/file/slides_reader.py` & `gpt_index-0.7.7/llama_index/readers/file/slides_reader.py`

 * *Files identical despite different names*

### Comparing `gpt_index-0.7.6/llama_index/readers/file/tabular_reader.py` & `gpt_index-0.7.7/llama_index/readers/file/tabular_reader.py`

 * *Files identical despite different names*

### Comparing `gpt_index-0.7.6/llama_index/readers/file/video_audio_reader.py` & `gpt_index-0.7.7/llama_index/readers/file/video_audio_reader.py`

 * *Files identical despite different names*

### Comparing `gpt_index-0.7.6/llama_index/readers/github_readers/github_api_client.py` & `gpt_index-0.7.7/llama_index/readers/github_readers/github_api_client.py`

 * *Files identical despite different names*

### Comparing `gpt_index-0.7.6/llama_index/readers/github_readers/github_repository_reader.py` & `gpt_index-0.7.7/llama_index/readers/github_readers/github_repository_reader.py`

 * *Files identical despite different names*

### Comparing `gpt_index-0.7.6/llama_index/readers/github_readers/utils.py` & `gpt_index-0.7.7/llama_index/readers/github_readers/utils.py`

 * *Files identical despite different names*

### Comparing `gpt_index-0.7.6/llama_index/readers/google_readers/gdocs.py` & `gpt_index-0.7.7/llama_index/readers/google_readers/gdocs.py`

 * *Files identical despite different names*

### Comparing `gpt_index-0.7.6/llama_index/readers/google_readers/gsheets.py` & `gpt_index-0.7.7/llama_index/readers/google_readers/gsheets.py`

 * *Files identical despite different names*

### Comparing `gpt_index-0.7.6/llama_index/readers/json.py` & `gpt_index-0.7.7/llama_index/readers/json.py`

 * *Files identical despite different names*

### Comparing `gpt_index-0.7.6/llama_index/readers/make_com/wrapper.py` & `gpt_index-0.7.7/llama_index/readers/make_com/wrapper.py`

 * *Files identical despite different names*

### Comparing `gpt_index-0.7.6/llama_index/readers/mbox.py` & `gpt_index-0.7.7/llama_index/readers/mbox.py`

 * *Files identical despite different names*

### Comparing `gpt_index-0.7.6/llama_index/readers/metal.py` & `gpt_index-0.7.7/llama_index/readers/metal.py`

 * *Files identical despite different names*

### Comparing `gpt_index-0.7.6/llama_index/readers/milvus.py` & `gpt_index-0.7.7/llama_index/readers/milvus.py`

 * *Files identical despite different names*

### Comparing `gpt_index-0.7.6/llama_index/readers/mongo.py` & `gpt_index-0.7.7/llama_index/readers/mongo.py`

 * *Files identical despite different names*

### Comparing `gpt_index-0.7.6/llama_index/readers/myscale.py` & `gpt_index-0.7.7/llama_index/readers/myscale.py`

 * *Files identical despite different names*

### Comparing `gpt_index-0.7.6/llama_index/readers/notion.py` & `gpt_index-0.7.7/llama_index/readers/notion.py`

 * *Files identical despite different names*

### Comparing `gpt_index-0.7.6/llama_index/readers/obsidian.py` & `gpt_index-0.7.7/llama_index/readers/obsidian.py`

 * *Files identical despite different names*

### Comparing `gpt_index-0.7.6/llama_index/readers/pinecone.py` & `gpt_index-0.7.7/llama_index/readers/pinecone.py`

 * *Files identical despite different names*

### Comparing `gpt_index-0.7.6/llama_index/readers/psychic.py` & `gpt_index-0.7.7/llama_index/readers/psychic.py`

 * *Files identical despite different names*

### Comparing `gpt_index-0.7.6/llama_index/readers/qdrant.py` & `gpt_index-0.7.7/llama_index/readers/qdrant.py`

 * *Files identical despite different names*

### Comparing `gpt_index-0.7.6/llama_index/readers/redis/utils.py` & `gpt_index-0.7.7/llama_index/readers/redis/utils.py`

 * *Files identical despite different names*

### Comparing `gpt_index-0.7.6/llama_index/readers/slack.py` & `gpt_index-0.7.7/llama_index/readers/slack.py`

 * *Files identical despite different names*

### Comparing `gpt_index-0.7.6/llama_index/readers/steamship/file_reader.py` & `gpt_index-0.7.7/llama_index/readers/steamship/file_reader.py`

 * *Files identical despite different names*

### Comparing `gpt_index-0.7.6/llama_index/readers/string_iterable.py` & `gpt_index-0.7.7/llama_index/readers/string_iterable.py`

 * *Files identical despite different names*

### Comparing `gpt_index-0.7.6/llama_index/readers/twitter.py` & `gpt_index-0.7.7/llama_index/readers/twitter.py`

 * *Files identical despite different names*

### Comparing `gpt_index-0.7.6/llama_index/readers/weaviate/reader.py` & `gpt_index-0.7.7/llama_index/readers/weaviate/reader.py`

 * *Files identical despite different names*

### Comparing `gpt_index-0.7.6/llama_index/readers/web.py` & `gpt_index-0.7.7/llama_index/readers/web.py`

 * *Files identical despite different names*

### Comparing `gpt_index-0.7.6/llama_index/readers/wikipedia.py` & `gpt_index-0.7.7/llama_index/readers/wikipedia.py`

 * *Files identical despite different names*

### Comparing `gpt_index-0.7.6/llama_index/readers/youtube_transcript.py` & `gpt_index-0.7.7/llama_index/readers/youtube_transcript.py`

 * *Files identical despite different names*

### Comparing `gpt_index-0.7.6/llama_index/response/notebook_utils.py` & `gpt_index-0.7.7/llama_index/response/notebook_utils.py`

 * *Files identical despite different names*

### Comparing `gpt_index-0.7.6/llama_index/response/pprint_utils.py` & `gpt_index-0.7.7/llama_index/response/pprint_utils.py`

 * *Files identical despite different names*

### Comparing `gpt_index-0.7.6/llama_index/response/schema.py` & `gpt_index-0.7.7/llama_index/response/schema.py`

 * *Files identical despite different names*

### Comparing `gpt_index-0.7.6/llama_index/response_synthesizers/__init__.py` & `gpt_index-0.7.7/llama_index/response_synthesizers/__init__.py`

 * *Files identical despite different names*

### Comparing `gpt_index-0.7.6/llama_index/response_synthesizers/accumulate.py` & `gpt_index-0.7.7/llama_index/response_synthesizers/accumulate.py`

 * *Files identical despite different names*

### Comparing `gpt_index-0.7.6/llama_index/response_synthesizers/base.py` & `gpt_index-0.7.7/llama_index/response_synthesizers/base.py`

 * *Files identical despite different names*

### Comparing `gpt_index-0.7.6/llama_index/response_synthesizers/compact_and_accumulate.py` & `gpt_index-0.7.7/llama_index/response_synthesizers/compact_and_accumulate.py`

 * *Files identical despite different names*

### Comparing `gpt_index-0.7.6/llama_index/response_synthesizers/compact_and_refine.py` & `gpt_index-0.7.7/llama_index/response_synthesizers/compact_and_refine.py`

 * *Files identical despite different names*

### Comparing `gpt_index-0.7.6/llama_index/response_synthesizers/factory.py` & `gpt_index-0.7.7/llama_index/response_synthesizers/factory.py`

 * *Files identical despite different names*

### Comparing `gpt_index-0.7.6/llama_index/response_synthesizers/generation.py` & `gpt_index-0.7.7/llama_index/response_synthesizers/generation.py`

 * *Files identical despite different names*

### Comparing `gpt_index-0.7.6/llama_index/response_synthesizers/no_text.py` & `gpt_index-0.7.7/llama_index/response_synthesizers/no_text.py`

 * *Files identical despite different names*

### Comparing `gpt_index-0.7.6/llama_index/response_synthesizers/refine.py` & `gpt_index-0.7.7/llama_index/response_synthesizers/refine.py`

 * *Files identical despite different names*

### Comparing `gpt_index-0.7.6/llama_index/response_synthesizers/simple_summarize.py` & `gpt_index-0.7.7/llama_index/response_synthesizers/simple_summarize.py`

 * *Files identical despite different names*

### Comparing `gpt_index-0.7.6/llama_index/response_synthesizers/tree_summarize.py` & `gpt_index-0.7.7/llama_index/response_synthesizers/tree_summarize.py`

 * *Files identical despite different names*

### Comparing `gpt_index-0.7.6/llama_index/response_synthesizers/type.py` & `gpt_index-0.7.7/llama_index/response_synthesizers/type.py`

 * *Files identical despite different names*

### Comparing `gpt_index-0.7.6/llama_index/retrievers/__init__.py` & `gpt_index-0.7.7/llama_index/retrievers/__init__.py`

 * *Files identical despite different names*

### Comparing `gpt_index-0.7.6/llama_index/retrievers/recursive_retriever.py` & `gpt_index-0.7.7/llama_index/retrievers/recursive_retriever.py`

 * *Files identical despite different names*

### Comparing `gpt_index-0.7.6/llama_index/retrievers/transform_retriever.py` & `gpt_index-0.7.7/llama_index/retrievers/transform_retriever.py`

 * *Files identical despite different names*

### Comparing `gpt_index-0.7.6/llama_index/schema.py` & `gpt_index-0.7.7/llama_index/schema.py`
...
### Comparing `gpt_index-0.7.6/llama_index/selectors/llm_selectors.py` & `gpt_index-0.7.7/llama_index/selectors/llm_selectors.py`

 * *Files identical despite different names*

### Comparing `gpt_index-0.7.6/llama_index/selectors/prompts.py` & `gpt_index-0.7.7/llama_index/selectors/prompts.py`

 * *Files identical despite different names*

### Comparing `gpt_index-0.7.6/llama_index/selectors/pydantic_selectors.py` & `gpt_index-0.7.7/llama_index/selectors/pydantic_selectors.py`

 * *Files identical despite different names*

### Comparing `gpt_index-0.7.6/llama_index/selectors/types.py` & `gpt_index-0.7.7/llama_index/selectors/types.py`

 * *Files identical despite different names*

### Comparing `gpt_index-0.7.6/llama_index/storage/docstore/__init__.py` & `gpt_index-0.7.7/llama_index/storage/docstore/__init__.py`

 * *Files identical despite different names*

### Comparing `gpt_index-0.7.6/llama_index/storage/docstore/dynamodb_docstore.py` & `gpt_index-0.7.7/llama_index/storage/docstore/dynamodb_docstore.py`

 * *Files identical despite different names*

### Comparing `gpt_index-0.7.6/llama_index/storage/docstore/keyval_docstore.py` & `gpt_index-0.7.7/llama_index/storage/docstore/keyval_docstore.py`

 * *Files identical despite different names*

### Comparing `gpt_index-0.7.6/llama_index/storage/docstore/mongo_docstore.py` & `gpt_index-0.7.7/llama_index/storage/docstore/mongo_docstore.py`

 * *Files identical despite different names*

### Comparing `gpt_index-0.7.6/llama_index/storage/docstore/redis_docstore.py` & `gpt_index-0.7.7/llama_index/storage/docstore/redis_docstore.py`

 * *Files identical despite different names*

### Comparing `gpt_index-0.7.6/llama_index/storage/docstore/registry.py` & `gpt_index-0.7.7/llama_index/storage/docstore/registry.py`

 * *Files identical despite different names*

### Comparing `gpt_index-0.7.6/llama_index/storage/docstore/simple_docstore.py` & `gpt_index-0.7.7/llama_index/storage/docstore/simple_docstore.py`

 * *Files identical despite different names*

### Comparing `gpt_index-0.7.6/llama_index/storage/docstore/types.py` & `gpt_index-0.7.7/llama_index/storage/docstore/types.py`

 * *Files identical despite different names*

### Comparing `gpt_index-0.7.6/llama_index/storage/docstore/utils.py` & `gpt_index-0.7.7/llama_index/storage/docstore/utils.py`

 * *Files identical despite different names*

### Comparing `gpt_index-0.7.6/llama_index/storage/index_store/dynamodb_index_store.py` & `gpt_index-0.7.7/llama_index/storage/index_store/dynamodb_index_store.py`

 * *Files identical despite different names*

### Comparing `gpt_index-0.7.6/llama_index/storage/index_store/keyval_index_store.py` & `gpt_index-0.7.7/llama_index/storage/index_store/keyval_index_store.py`

 * *Files identical despite different names*

### Comparing `gpt_index-0.7.6/llama_index/storage/index_store/mongo_index_store.py` & `gpt_index-0.7.7/llama_index/storage/index_store/mongo_index_store.py`

 * *Files identical despite different names*

### Comparing `gpt_index-0.7.6/llama_index/storage/index_store/redis_index_store.py` & `gpt_index-0.7.7/llama_index/storage/index_store/redis_index_store.py`

 * *Files identical despite different names*

### Comparing `gpt_index-0.7.6/llama_index/storage/index_store/simple_index_store.py` & `gpt_index-0.7.7/llama_index/storage/index_store/simple_index_store.py`

 * *Files identical despite different names*

### Comparing `gpt_index-0.7.6/llama_index/storage/index_store/types.py` & `gpt_index-0.7.7/llama_index/storage/index_store/types.py`

 * *Files identical despite different names*

### Comparing `gpt_index-0.7.6/llama_index/storage/index_store/utils.py` & `gpt_index-0.7.7/llama_index/storage/index_store/utils.py`

 * *Files identical despite different names*

### Comparing `gpt_index-0.7.6/llama_index/storage/kvstore/dynamodb_kvstore.py` & `gpt_index-0.7.7/llama_index/storage/kvstore/dynamodb_kvstore.py`

 * *Files identical despite different names*

### Comparing `gpt_index-0.7.6/llama_index/storage/kvstore/mongodb_kvstore.py` & `gpt_index-0.7.7/llama_index/storage/kvstore/mongodb_kvstore.py`

 * *Files identical despite different names*

### Comparing `gpt_index-0.7.6/llama_index/storage/kvstore/redis_kvstore.py` & `gpt_index-0.7.7/llama_index/storage/kvstore/redis_kvstore.py`

 * *Files identical despite different names*

### Comparing `gpt_index-0.7.6/llama_index/storage/kvstore/s3_kvstore.py` & `gpt_index-0.7.7/llama_index/storage/kvstore/s3_kvstore.py`

 * *Files identical despite different names*

### Comparing `gpt_index-0.7.6/llama_index/storage/kvstore/simple_kvstore.py` & `gpt_index-0.7.7/llama_index/storage/kvstore/simple_kvstore.py`

 * *Files identical despite different names*

### Comparing `gpt_index-0.7.6/llama_index/storage/kvstore/types.py` & `gpt_index-0.7.7/llama_index/storage/kvstore/types.py`

 * *Files identical despite different names*

### Comparing `gpt_index-0.7.6/llama_index/storage/storage_context.py` & `gpt_index-0.7.7/llama_index/storage/storage_context.py`

 * *Files identical despite different names*

### Comparing `gpt_index-0.7.6/llama_index/token_counter/mock_embed_model.py` & `gpt_index-0.7.7/llama_index/token_counter/mock_embed_model.py`

 * *Files identical despite different names*

### Comparing `gpt_index-0.7.6/llama_index/token_counter/utils.py` & `gpt_index-0.7.7/llama_index/token_counter/utils.py`

 * *Files identical despite different names*

### Comparing `gpt_index-0.7.6/llama_index/tools/function_tool.py` & `gpt_index-0.7.7/llama_index/tools/function_tool.py`

 * *Files identical despite different names*

### Comparing `gpt_index-0.7.6/llama_index/tools/ondemand_loader_tool.py` & `gpt_index-0.7.7/llama_index/tools/ondemand_loader_tool.py`

 * *Files identical despite different names*

### Comparing `gpt_index-0.7.6/llama_index/tools/query_engine.py` & `gpt_index-0.7.7/llama_index/tools/query_engine.py`
...
### Comparing `gpt_index-0.7.6/llama_index/tools/query_plan.py` & `gpt_index-0.7.7/llama_index/tools/query_plan.py`

 * *Files identical despite different names*

### Comparing `gpt_index-0.7.6/llama_index/tools/tool_spec/base.py` & `gpt_index-0.7.7/llama_index/tools/tool_spec/base.py`

 * *Files identical despite different names*

### Comparing `gpt_index-0.7.6/llama_index/tools/tool_spec/load_and_search/base.py` & `gpt_index-0.7.7/llama_index/tools/tool_spec/load_and_search/base.py`

 * *Files identical despite different names*

### Comparing `gpt_index-0.7.6/llama_index/tools/tool_spec/notion/base.py` & `gpt_index-0.7.7/llama_index/tools/tool_spec/notion/base.py`

 * *Files identical despite different names*

### Comparing `gpt_index-0.7.6/llama_index/tools/tool_spec/slack/base.py` & `gpt_index-0.7.7/llama_index/tools/tool_spec/slack/base.py`

 * *Files identical despite different names*

### Comparing `gpt_index-0.7.6/llama_index/tools/types.py` & `gpt_index-0.7.7/llama_index/tools/types.py`

 * *Files identical despite different names*

### Comparing `gpt_index-0.7.6/llama_index/tools/utils.py` & `gpt_index-0.7.7/llama_index/tools/utils.py`

 * *Files identical despite different names*

### Comparing `gpt_index-0.7.6/llama_index/tts/bark.py` & `gpt_index-0.7.7/llama_index/tts/bark.py`

 * *Files identical despite different names*

### Comparing `gpt_index-0.7.6/llama_index/tts/base.py` & `gpt_index-0.7.7/llama_index/tts/base.py`

 * *Files identical despite different names*

### Comparing `gpt_index-0.7.6/llama_index/tts/elevenlabs.py` & `gpt_index-0.7.7/llama_index/tts/elevenlabs.py`

 * *Files identical despite different names*

### Comparing `gpt_index-0.7.6/llama_index/types.py` & `gpt_index-0.7.7/llama_index/types.py`

 * *Files identical despite different names*

### Comparing `gpt_index-0.7.6/llama_index/utils.py` & `gpt_index-0.7.7/llama_index/utils.py`
...
### Comparing `gpt_index-0.7.6/llama_index/vector_stores/__init__.py` & `gpt_index-0.7.7/llama_index/vector_stores/__init__.py`

 * *Files identical despite different names*

### Comparing `gpt_index-0.7.6/llama_index/vector_stores/chatgpt_plugin.py` & `gpt_index-0.7.7/llama_index/vector_stores/chatgpt_plugin.py`

 * *Files identical despite different names*

### Comparing `gpt_index-0.7.6/llama_index/vector_stores/chroma.py` & `gpt_index-0.7.7/llama_index/vector_stores/chroma.py`

 * *Files identical despite different names*

### Comparing `gpt_index-0.7.6/llama_index/vector_stores/deeplake.py` & `gpt_index-0.7.7/llama_index/vector_stores/deeplake.py`

 * *Files identical despite different names*

### Comparing `gpt_index-0.7.6/llama_index/vector_stores/docarray/base.py` & `gpt_index-0.7.7/llama_index/vector_stores/docarray/base.py`

 * *Files identical despite different names*

### Comparing `gpt_index-0.7.6/llama_index/vector_stores/docarray/hnsw.py` & `gpt_index-0.7.7/llama_index/vector_stores/docarray/hnsw.py`

 * *Files identical despite different names*

### Comparing `gpt_index-0.7.6/llama_index/vector_stores/docarray/in_memory.py` & `gpt_index-0.7.7/llama_index/vector_stores/docarray/in_memory.py`

 * *Files identical despite different names*

### Comparing `gpt_index-0.7.6/llama_index/vector_stores/dynamodb.py` & `gpt_index-0.7.7/llama_index/vector_stores/dynamodb.py`

 * *Files identical despite different names*

### Comparing `gpt_index-0.7.6/llama_index/vector_stores/faiss.py` & `gpt_index-0.7.7/llama_index/vector_stores/faiss.py`

 * *Files identical despite different names*

### Comparing `gpt_index-0.7.6/llama_index/vector_stores/lancedb.py` & `gpt_index-0.7.7/llama_index/vector_stores/lancedb.py`

 * *Files identical despite different names*

### Comparing `gpt_index-0.7.6/llama_index/vector_stores/metal.py` & `gpt_index-0.7.7/llama_index/vector_stores/metal.py`

 * *Files identical despite different names*

### Comparing `gpt_index-0.7.6/llama_index/vector_stores/milvus.py` & `gpt_index-0.7.7/llama_index/vector_stores/milvus.py`
...
### Comparing `gpt_index-0.7.6/llama_index/vector_stores/mongodb.py` & `gpt_index-0.7.7/llama_index/vector_stores/mongodb.py`

 * *Files identical despite different names*

### Comparing `gpt_index-0.7.6/llama_index/vector_stores/myscale.py` & `gpt_index-0.7.7/llama_index/vector_stores/myscale.py`

 * *Files identical despite different names*

### Comparing `gpt_index-0.7.6/llama_index/vector_stores/opensearch.py` & `gpt_index-0.7.7/llama_index/vector_stores/opensearch.py`

 * *Files identical despite different names*

### Comparing `gpt_index-0.7.6/llama_index/vector_stores/pinecone.py` & `gpt_index-0.7.7/llama_index/vector_stores/pinecone.py`

 * *Files identical despite different names*

### Comparing `gpt_index-0.7.6/llama_index/vector_stores/postgres.py` & `gpt_index-0.7.7/llama_index/vector_stores/postgres.py`

 * *Files identical despite different names*

### Comparing `gpt_index-0.7.6/llama_index/vector_stores/qdrant.py` & `gpt_index-0.7.7/llama_index/vector_stores/qdrant.py`

 * *Files identical despite different names*

### Comparing `gpt_index-0.7.6/llama_index/vector_stores/redis.py` & `gpt_index-0.7.7/llama_index/vector_stores/redis.py`

 * *Files identical despite different names*

### Comparing `gpt_index-0.7.6/llama_index/vector_stores/registry.py` & `gpt_index-0.7.7/llama_index/vector_stores/registry.py`

 * *Files identical despite different names*

### Comparing `gpt_index-0.7.6/llama_index/vector_stores/simple.py` & `gpt_index-0.7.7/llama_index/vector_stores/simple.py`

 * *Files identical despite different names*

### Comparing `gpt_index-0.7.6/llama_index/vector_stores/supabase.py` & `gpt_index-0.7.7/llama_index/vector_stores/supabase.py`

 * *Files identical despite different names*

### Comparing `gpt_index-0.7.6/llama_index/vector_stores/tair.py` & `gpt_index-0.7.7/llama_index/vector_stores/tair.py`

 * *Files identical despite different names*

### Comparing `gpt_index-0.7.6/llama_index/vector_stores/types.py` & `gpt_index-0.7.7/llama_index/vector_stores/types.py`
...
### Comparing `gpt_index-0.7.6/llama_index/vector_stores/typesense.py` & `gpt_index-0.7.7/llama_index/vector_stores/typesense.py`

 * *Files identical despite different names*

### Comparing `gpt_index-0.7.6/llama_index/vector_stores/utils.py` & `gpt_index-0.7.7/llama_index/vector_stores/utils.py`
...
### Comparing `gpt_index-0.7.6/llama_index/vector_stores/weaviate.py` & `gpt_index-0.7.7/llama_index/vector_stores/weaviate.py`

 * *Files identical despite different names*

### Comparing `gpt_index-0.7.6/llama_index/vector_stores/weaviate_utils.py` & `gpt_index-0.7.7/llama_index/vector_stores/weaviate_utils.py`

 * *Files identical despite different names*

### Comparing `gpt_index-0.7.6/setup.py` & `gpt_index-0.7.7/setup.py`

 * *Files identical despite different names*

### Comparing `gpt_index-0.7.6/tests/callbacks/test_llama_debug.py` & `gpt_index-0.7.7/tests/callbacks/test_llama_debug.py`

 * *Files identical despite different names*

### Comparing `gpt_index-0.7.6/tests/callbacks/test_token_counter.py` & `gpt_index-0.7.7/tests/callbacks/test_token_counter.py`

 * *Files identical despite different names*

### Comparing `gpt_index-0.7.6/tests/chat_engine/test_condense_question.py` & `gpt_index-0.7.7/tests/chat_engine/test_condense_question.py`

 * *Files identical despite different names*

### Comparing `gpt_index-0.7.6/tests/chat_engine/test_simple.py` & `gpt_index-0.7.7/tests/chat_engine/test_simple.py`

 * *Files identical despite different names*

### Comparing `gpt_index-0.7.6/tests/conftest.py` & `gpt_index-0.7.7/tests/conftest.py`

 * *Files identical despite different names*

### Comparing `gpt_index-0.7.6/tests/embeddings/test_base.py` & `gpt_index-0.7.7/tests/embeddings/test_base.py`

 * *Files identical despite different names*

### Comparing `gpt_index-0.7.6/tests/indices/composability/test_utils.py` & `gpt_index-0.7.7/tests/indices/composability/test_utils.py`

 * *Files identical despite different names*

### Comparing `gpt_index-0.7.6/tests/indices/conftest.py` & `gpt_index-0.7.7/tests/indices/conftest.py`

 * *Files identical despite different names*

### Comparing `gpt_index-0.7.6/tests/indices/document_summary/test_index.py` & `gpt_index-0.7.7/tests/indices/document_summary/test_index.py`

 * *Files identical despite different names*

### Comparing `gpt_index-0.7.6/tests/indices/empty/test_base.py` & `gpt_index-0.7.7/tests/indices/empty/test_base.py`

 * *Files identical despite different names*

### Comparing `gpt_index-0.7.6/tests/indices/keyword_table/test_base.py` & `gpt_index-0.7.7/tests/indices/keyword_table/test_base.py`

 * *Files identical despite different names*

### Comparing `gpt_index-0.7.6/tests/indices/keyword_table/test_retrievers.py` & `gpt_index-0.7.7/tests/indices/keyword_table/test_retrievers.py`

 * *Files identical despite different names*

### Comparing `gpt_index-0.7.6/tests/indices/keyword_table/test_utils.py` & `gpt_index-0.7.7/tests/indices/keyword_table/test_utils.py`

 * *Files identical despite different names*

### Comparing `gpt_index-0.7.6/tests/indices/knowledge_graph/test_base.py` & `gpt_index-0.7.7/tests/indices/knowledge_graph/test_base.py`

 * *Files identical despite different names*

### Comparing `gpt_index-0.7.6/tests/indices/knowledge_graph/test_retrievers.py` & `gpt_index-0.7.7/tests/indices/knowledge_graph/test_retrievers.py`

 * *Files identical despite different names*

### Comparing `gpt_index-0.7.6/tests/indices/list/test_index.py` & `gpt_index-0.7.7/tests/indices/list/test_index.py`

 * *Files identical despite different names*

### Comparing `gpt_index-0.7.6/tests/indices/list/test_retrievers.py` & `gpt_index-0.7.7/tests/indices/list/test_retrievers.py`

 * *Files identical despite different names*

### Comparing `gpt_index-0.7.6/tests/indices/postprocessor/test_base.py` & `gpt_index-0.7.7/tests/indices/postprocessor/test_base.py`

 * *Files identical despite different names*

### Comparing `gpt_index-0.7.6/tests/indices/postprocessor/test_llm_rerank.py` & `gpt_index-0.7.7/tests/indices/postprocessor/test_llm_rerank.py`

 * *Files identical despite different names*

### Comparing `gpt_index-0.7.6/tests/indices/postprocessor/test_optimizer.py` & `gpt_index-0.7.7/tests/indices/postprocessor/test_optimizer.py`

 * *Files identical despite different names*

### Comparing `gpt_index-0.7.6/tests/indices/query/conftest.py` & `gpt_index-0.7.7/tests/indices/query/conftest.py`

 * *Files identical despite different names*

### Comparing `gpt_index-0.7.6/tests/indices/query/query_transform/test_base.py` & `gpt_index-0.7.7/tests/indices/query/query_transform/test_base.py`

 * *Files identical despite different names*

### Comparing `gpt_index-0.7.6/tests/indices/query/test_compose.py` & `gpt_index-0.7.7/tests/indices/query/test_compose.py`

 * *Files identical despite different names*

### Comparing `gpt_index-0.7.6/tests/indices/query/test_compose_vector.py` & `gpt_index-0.7.7/tests/indices/query/test_compose_vector.py`

 * *Files identical despite different names*

### Comparing `gpt_index-0.7.6/tests/indices/query/test_embedding_utils.py` & `gpt_index-0.7.7/tests/indices/query/test_embedding_utils.py`

 * *Files identical despite different names*

### Comparing `gpt_index-0.7.6/tests/indices/query/test_query_bundle.py` & `gpt_index-0.7.7/tests/indices/query/test_query_bundle.py`

 * *Files identical despite different names*

### Comparing `gpt_index-0.7.6/tests/indices/struct_store/conftest.py` & `gpt_index-0.7.7/tests/indices/struct_store/conftest.py`

 * *Files identical despite different names*

### Comparing `gpt_index-0.7.6/tests/indices/struct_store/test_base.py` & `gpt_index-0.7.7/tests/indices/struct_store/test_base.py`

 * *Files identical despite different names*

### Comparing `gpt_index-0.7.6/tests/indices/struct_store/test_json_query.py` & `gpt_index-0.7.7/tests/indices/struct_store/test_json_query.py`

 * *Files identical despite different names*

### Comparing `gpt_index-0.7.6/tests/indices/struct_store/test_sql_query.py` & `gpt_index-0.7.7/tests/indices/struct_store/test_sql_query.py`

 * *Files identical despite different names*

### Comparing `gpt_index-0.7.6/tests/indices/test_loading.py` & `gpt_index-0.7.7/tests/indices/test_loading.py`

 * *Files identical despite different names*

### Comparing `gpt_index-0.7.6/tests/indices/test_loading_graph.py` & `gpt_index-0.7.7/tests/indices/test_loading_graph.py`

 * *Files identical despite different names*

### Comparing `gpt_index-0.7.6/tests/indices/test_node_utils.py` & `gpt_index-0.7.7/tests/indices/test_node_utils.py`

 * *Files identical despite different names*

### Comparing `gpt_index-0.7.6/tests/indices/test_prompt_helper.py` & `gpt_index-0.7.7/tests/indices/test_prompt_helper.py`

 * *Files identical despite different names*

### Comparing `gpt_index-0.7.6/tests/indices/tree/conftest.py` & `gpt_index-0.7.7/tests/indices/tree/conftest.py`

 * *Files identical despite different names*

### Comparing `gpt_index-0.7.6/tests/indices/tree/test_embedding_retriever.py` & `gpt_index-0.7.7/tests/indices/tree/test_embedding_retriever.py`

 * *Files identical despite different names*

### Comparing `gpt_index-0.7.6/tests/indices/tree/test_index.py` & `gpt_index-0.7.7/tests/indices/tree/test_index.py`

 * *Files identical despite different names*

### Comparing `gpt_index-0.7.6/tests/indices/tree/test_retrievers.py` & `gpt_index-0.7.7/tests/indices/tree/test_retrievers.py`

 * *Files identical despite different names*

### Comparing `gpt_index-0.7.6/tests/indices/vector_store/auto_retriever/test_output_parser.py` & `gpt_index-0.7.7/tests/indices/vector_store/auto_retriever/test_output_parser.py`

 * *Files identical despite different names*

### Comparing `gpt_index-0.7.6/tests/indices/vector_store/conftest.py` & `gpt_index-0.7.7/tests/indices/vector_store/conftest.py`

 * *Files identical despite different names*

### Comparing `gpt_index-0.7.6/tests/indices/vector_store/mock_faiss.py` & `gpt_index-0.7.7/tests/indices/vector_store/mock_faiss.py`

 * *Files identical despite different names*

### Comparing `gpt_index-0.7.6/tests/indices/vector_store/mock_services.py` & `gpt_index-0.7.7/tests/indices/vector_store/mock_services.py`

 * *Files identical despite different names*

### Comparing `gpt_index-0.7.6/tests/indices/vector_store/test_faiss.py` & `gpt_index-0.7.7/tests/indices/vector_store/test_faiss.py`

 * *Files identical despite different names*

### Comparing `gpt_index-0.7.6/tests/indices/vector_store/test_myscale.py` & `gpt_index-0.7.7/tests/indices/vector_store/test_myscale.py`

 * *Files identical despite different names*

### Comparing `gpt_index-0.7.6/tests/indices/vector_store/test_pinecone.py` & `gpt_index-0.7.7/tests/indices/vector_store/test_pinecone.py`

 * *Files identical despite different names*

### Comparing `gpt_index-0.7.6/tests/indices/vector_store/test_retrievers.py` & `gpt_index-0.7.7/tests/indices/vector_store/test_retrievers.py`

 * *Files identical despite different names*

### Comparing `gpt_index-0.7.6/tests/indices/vector_store/test_simple.py` & `gpt_index-0.7.7/tests/indices/vector_store/test_simple.py`

 * *Files identical despite different names*

### Comparing `gpt_index-0.7.6/tests/indices/vector_store/utils.py` & `gpt_index-0.7.7/tests/indices/vector_store/utils.py`

 * *Files identical despite different names*

### Comparing `gpt_index-0.7.6/tests/langchain_helpers/test_text_splitter.py` & `gpt_index-0.7.7/tests/langchain_helpers/test_text_splitter.py`

 * *Files identical despite different names*

### Comparing `gpt_index-0.7.6/tests/llm_predictor/test_base.py` & `gpt_index-0.7.7/tests/llm_predictor/test_base.py`
...
### Comparing `gpt_index-0.7.6/tests/llm_predictor/vellum/conftest.py` & `gpt_index-0.7.7/tests/llm_predictor/vellum/conftest.py`

 * *Files identical despite different names*

### Comparing `gpt_index-0.7.6/tests/llm_predictor/vellum/test_predictor.py` & `gpt_index-0.7.7/tests/llm_predictor/vellum/test_predictor.py`

 * *Files identical despite different names*

### Comparing `gpt_index-0.7.6/tests/llm_predictor/vellum/test_prompt_registry.py` & `gpt_index-0.7.7/tests/llm_predictor/vellum/test_prompt_registry.py`

 * *Files identical despite different names*

### Comparing `gpt_index-0.7.6/tests/llms/test_anthropic.py` & `gpt_index-0.7.7/tests/llms/test_anthropic.py`

 * *Files identical despite different names*

### Comparing `gpt_index-0.7.6/tests/llms/test_anthropic_utils.py` & `gpt_index-0.7.7/tests/llms/test_anthropic_utils.py`

 * *Files identical despite different names*

### Comparing `gpt_index-0.7.6/tests/llms/test_custom.py` & `gpt_index-0.7.7/tests/llms/test_custom.py`

 * *Files identical despite different names*

### Comparing `gpt_index-0.7.6/tests/llms/test_langchain.py` & `gpt_index-0.7.7/tests/llms/test_langchain.py`

 * *Files identical despite different names*

### Comparing `gpt_index-0.7.6/tests/llms/test_openai.py` & `gpt_index-0.7.7/tests/llms/test_openai.py`

 * *Files identical despite different names*

### Comparing `gpt_index-0.7.6/tests/llms/test_openai_utils.py` & `gpt_index-0.7.7/tests/llms/test_openai_utils.py`

 * *Files identical despite different names*

### Comparing `gpt_index-0.7.6/tests/llms/test_palm.py` & `gpt_index-0.7.7/tests/llms/test_palm.py`

 * *Files identical despite different names*

### Comparing `gpt_index-0.7.6/tests/logger/test_base.py` & `gpt_index-0.7.7/tests/logger/test_base.py`

 * *Files identical despite different names*

### Comparing `gpt_index-0.7.6/tests/mock_utils/mock_predict.py` & `gpt_index-0.7.7/tests/mock_utils/mock_predict.py`

 * *Files identical despite different names*

### Comparing `gpt_index-0.7.6/tests/mock_utils/mock_prompts.py` & `gpt_index-0.7.7/tests/mock_utils/mock_prompts.py`

 * *Files identical despite different names*

### Comparing `gpt_index-0.7.6/tests/mock_utils/mock_text_splitter.py` & `gpt_index-0.7.7/tests/mock_utils/mock_text_splitter.py`

 * *Files identical despite different names*

### Comparing `gpt_index-0.7.6/tests/mock_utils/mock_utils.py` & `gpt_index-0.7.7/tests/mock_utils/mock_utils.py`

 * *Files identical despite different names*

### Comparing `gpt_index-0.7.6/tests/objects/test_base.py` & `gpt_index-0.7.7/tests/objects/test_base.py`

 * *Files identical despite different names*

### Comparing `gpt_index-0.7.6/tests/objects/test_node_mapping.py` & `gpt_index-0.7.7/tests/objects/test_node_mapping.py`

 * *Files identical despite different names*

### Comparing `gpt_index-0.7.6/tests/output_parsers/test_base.py` & `gpt_index-0.7.7/tests/output_parsers/test_base.py`

 * *Files identical despite different names*

### Comparing `gpt_index-0.7.6/tests/output_parsers/test_pydantic.py` & `gpt_index-0.7.7/tests/output_parsers/test_pydantic.py`

 * *Files identical despite different names*

### Comparing `gpt_index-0.7.6/tests/output_parsers/test_selection.py` & `gpt_index-0.7.7/tests/output_parsers/test_selection.py`

 * *Files identical despite different names*

### Comparing `gpt_index-0.7.6/tests/playground/test_base.py` & `gpt_index-0.7.7/tests/playground/test_base.py`

 * *Files identical despite different names*

### Comparing `gpt_index-0.7.6/tests/program/test_guidance.py` & `gpt_index-0.7.7/tests/program/test_guidance.py`

 * *Files identical despite different names*

### Comparing `gpt_index-0.7.6/tests/program/test_llm_program.py` & `gpt_index-0.7.7/tests/program/test_llm_program.py`

 * *Files identical despite different names*

### Comparing `gpt_index-0.7.6/tests/prompts/test_base.py` & `gpt_index-0.7.7/tests/prompts/test_base.py`

 * *Files identical despite different names*

### Comparing `gpt_index-0.7.6/tests/prompts/test_guidance_utils.py` & `gpt_index-0.7.7/tests/prompts/test_guidance_utils.py`

 * *Files identical despite different names*

### Comparing `gpt_index-0.7.6/tests/question_gen/test_guidance_generator.py` & `gpt_index-0.7.7/tests/question_gen/test_guidance_generator.py`

 * *Files identical despite different names*

### Comparing `gpt_index-0.7.6/tests/question_gen/test_llm_generators.py` & `gpt_index-0.7.7/tests/question_gen/test_llm_generators.py`

 * *Files identical despite different names*

### Comparing `gpt_index-0.7.6/tests/readers/test_file.py` & `gpt_index-0.7.7/tests/readers/test_file.py`

 * *Files identical despite different names*

### Comparing `gpt_index-0.7.6/tests/readers/test_json.py` & `gpt_index-0.7.7/tests/readers/test_json.py`

 * *Files identical despite different names*

### Comparing `gpt_index-0.7.6/tests/readers/test_mongo.py` & `gpt_index-0.7.7/tests/readers/test_mongo.py`

 * *Files identical despite different names*

### Comparing `gpt_index-0.7.6/tests/selectors/test_llm_selectors.py` & `gpt_index-0.7.7/tests/selectors/test_llm_selectors.py`

 * *Files identical despite different names*

### Comparing `gpt_index-0.7.6/tests/storage/conftest.py` & `gpt_index-0.7.7/tests/storage/conftest.py`

 * *Files identical despite different names*

### Comparing `gpt_index-0.7.6/tests/storage/docstore/test_dynamodb_docstore.py` & `gpt_index-0.7.7/tests/storage/docstore/test_dynamodb_docstore.py`

 * *Files identical despite different names*

### Comparing `gpt_index-0.7.6/tests/storage/docstore/test_mongo_docstore.py` & `gpt_index-0.7.7/tests/storage/docstore/test_mongo_docstore.py`

 * *Files identical despite different names*

### Comparing `gpt_index-0.7.6/tests/storage/docstore/test_redis_docstore.py` & `gpt_index-0.7.7/tests/storage/docstore/test_redis_docstore.py`

 * *Files identical despite different names*

### Comparing `gpt_index-0.7.6/tests/storage/docstore/test_simple_docstore.py` & `gpt_index-0.7.7/tests/storage/docstore/test_simple_docstore.py`

 * *Files identical despite different names*

### Comparing `gpt_index-0.7.6/tests/storage/test_storage_context.py` & `gpt_index-0.7.7/tests/storage/test_storage_context.py`

 * *Files identical despite different names*

### Comparing `gpt_index-0.7.6/tests/test_utils.py` & `gpt_index-0.7.7/tests/test_utils.py`

 * *Files identical despite different names*

### Comparing `gpt_index-0.7.6/tests/token_predictor/test_base.py` & `gpt_index-0.7.7/tests/token_predictor/test_base.py`

 * *Files identical despite different names*

### Comparing `gpt_index-0.7.6/tests/tools/test_base.py` & `gpt_index-0.7.7/tests/tools/test_base.py`

 * *Files identical despite different names*

### Comparing `gpt_index-0.7.6/tests/tools/test_ondemand_loader.py` & `gpt_index-0.7.7/tests/tools/test_ondemand_loader.py`

 * *Files identical despite different names*

### Comparing `gpt_index-0.7.6/tests/tools/test_utils.py` & `gpt_index-0.7.7/tests/tools/test_utils.py`

 * *Files identical despite different names*

### Comparing `gpt_index-0.7.6/tests/tools/tool_spec/test_base.py` & `gpt_index-0.7.7/tests/tools/tool_spec/test_base.py`

 * *Files identical despite different names*

### Comparing `gpt_index-0.7.6/tests/vector_stores/test_docarray.py` & `gpt_index-0.7.7/tests/vector_stores/test_docarray.py`

 * *Files identical despite different names*

### Comparing `gpt_index-0.7.6/tests/vector_stores/test_postgres.py` & `gpt_index-0.7.7/tests/vector_stores/test_postgres.py`

 * *Files identical despite different names*

### Comparing `gpt_index-0.7.6/tests/vector_stores/test_qdrant.py` & `gpt_index-0.7.7/tests/vector_stores/test_qdrant.py`

 * *Files identical despite different names*

### Comparing `gpt_index-0.7.6/tests/vector_stores/test_tair.py` & `gpt_index-0.7.7/tests/vector_stores/test_tair.py`

 * *Files identical despite different names*

### Comparing `gpt_index-0.7.6/tests/vector_stores/test_weaviate.py` & `gpt_index-0.7.7/tests/vector_stores/test_weaviate.py`
